...
namespace StarBlue.HabboHotel.Groups.Forums
{
    public class GroupForumThread
    {
        ...
        {
            return StarBlueServer.GetHabboById(DeleterUserId);
        }
        ...
        public void SerializeData(GameClient Session, ServerPacket Packet)
        {
            ...
            Packet.WriteInteger((int)(StarBlueServer.GetUnixTimestamp() - Timestamp)); //Created Secs Ago
            ...
            if (deleter != null)
            {
                ...
                Packet.WriteInteger((int)(StarBlueServer.GetUnixTimestamp() - DeletedTimestamp));//deleted secs ago
            }
            else
            {
