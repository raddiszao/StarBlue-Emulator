...
{
    internal class SetVipCommand : IChatCommand
    {
        ...
        public void Execute(GameClient Session, Room Room, string[] Params)
        {
            ...
            TargetClient.GetHabbo().GetBadgeComponent().GiveBadge("VIP", true, Session);
            ...
            Session.SendWhisper("VIP dado com sucesso!", 34);
        }
    }
}