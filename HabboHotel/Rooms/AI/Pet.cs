    ...
    public class Pet
    {
        ...
        public void Addexperience(int Amount)
        {
            ...
            if (Room != null)
            {
                ...
                {
                    if (StarBlueServer.GetGame().GetClientManager().GetClientByUserID(OwnerId) != null)
                    {
                        StarBlueServer.GetGame().GetAchievementManager().ProgressAchievement(StarBlueServer.GetGame().GetClientManager().GetClientByUserID(OwnerId), "ACH_PetLevelUp", 1);
                    }
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = StarBlueServer.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (StarBlueServer.GetGame().GetRoomManager().TryGetRoom(RoomId, out Room _room))
                {
                    return _room;
                }
                else
