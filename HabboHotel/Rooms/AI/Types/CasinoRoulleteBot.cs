    ...
    class CasinoRoullete : BotAI
    {
        ...
        public override void OnUserSay(RoomUser User, string Message)
        {
            ...
            if (User.GetClient().GetHabbo().Diamonds >= 2 && BetsOpen == true)
            {
                ...
                {
                    GetRoomUser().Chat("Deve apostar entre 0 e 36.", false, 33);
                    return;
                }
                ...
                GetRoomUser().Chat("Aposta de " + IntMultiplier + " diamantes realiazada a " + IntBet + " por " + User.GetClient().GetHabbo().Username + ".", false, 33);
