...
namespace StarBlue.HabboHotel.Items.Utilities
{
    public static class PetUtility
    {
        public static bool CheckPetName(string PetName)
        {
            ...
            if (!StarBlueServer.IsValidAlphaNumeric(PetName))
            {
                return false;
            }
        ...
        {
            Pet pet = new Pet(0, UserId, 0, Name, Type, Race, Color, 0, 100, 100, 0, StarBlueServer.GetUnixTimestamp(), 0, 0, 0.0, 0, 0, 0, -1, "-1");
