...
namespace StarBlue.HabboHotel.Achievements
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("StarBlue.HabboHotel.Achievements.AchievementManager");
        ...
        public AchievementManager()
        {
            ...
            log.Info(">> Achievement Manager -> READY!");
        }
        ...
        public void TryProgressRegistrationAchievements(GameClient Session)
        {
            ...
            double sinceMember = StarBlueServer.GetUnixTimestamp() - (int)Session.GetHabbo().AccountCreated;
        ...
        public bool ProgressAchievement(GameClient Session, string AchievementGroup, int ProgressAmount, bool FromZero = false)
        {
            ...
            if (NewProgress >= TargetLevelData.Requirement)
            {
                ...
                // Set Talent
                if (StarBlueServer.GetGame().GetTalentManager().TryGetTalent(AchievementGroup, out Talent talent))
                {
                    StarBlueServer.GetGame().GetTalentManager().CompleteUserTalent(Session, talent);
                }
