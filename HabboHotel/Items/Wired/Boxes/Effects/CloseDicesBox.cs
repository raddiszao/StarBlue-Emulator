...
{
    internal class CloseDicesBox : IWiredItem, IWiredCycle
    {
        public Room Instance { get; set; }
        public Item Item { get; set; }
        public WiredBoxType Type => WiredBoxType.EffectCloseDices;
        ...
        public CloseDicesBox(Room Instance, Item Item)
        {
        ...
        public bool OnCycle()
        {
            ...
            if (counter > Delay)
            {
                ...
                foreach (Item Item in SetItems.Values.ToList())
                {
                    ...
                    if (Item.Data.InteractionType != InteractionType.DICE)
                    {
                        continue;
                    }
