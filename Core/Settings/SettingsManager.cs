...
namespace StarBlue.Core.Settings
{
    public class SettingsManager
    {
        private readonly Dictionary<string, string> _settings;

        private static readonly ILog Log = LogManager.GetLogger("StarBlue.Core.Settings.SettingsManager");
        ...
        {
            return _settings.ContainsKey(value) ? _settings[value] : "No setting found.";
        }
    }
}
