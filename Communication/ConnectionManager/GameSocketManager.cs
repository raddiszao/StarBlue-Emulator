using log4net;
using StarBlue.Communication.ConnectionManager.Socket_Exceptions;
            ...
            if (_connectionListener != null)
            {
                if (_acceptConnections)
                {
                    try
                    {
                        ...
                        if (WebEventManager.FirewallExists(ip))
                        {
                            return;
                        }
                        ...
                        else
                        {
                            ...
                            WebEventManager.BlockIpFirewall(replyFromComputer.RemoteEndPoint.ToString().Split(':')[0], true);
                        }
                    }
                    catch
                    {
