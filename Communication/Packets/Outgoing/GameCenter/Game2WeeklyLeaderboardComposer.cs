...
{
    public class Game2WeeklyLeaderboardComposer : MessageComposer // IZQUIERDA
    {
        private int GameId { get; }
        private int Week { get; }

        public Game2WeeklyLeaderboardComposer(int GameId, int Week)
            : base(Composers.Game2WeeklyLeaderboardMessageComposer)
        {
            this.GameId = GameId;
            this.Week = Week;
        }
        ...
        public override void Compose(Composer packet)
        {
            ...
            packet.WriteString("Custom - Izquierda");//Username
            ...
            packet.WriteInteger(10000);//Score
